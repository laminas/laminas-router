...
class SimpleTest extends TestCase
{
    ...
    public function testCustomRouteMatcherCanBeInjectedViaConstructor()
    {
        ...
        $routeMatcher = $this->getMock('Laminas\Console\RouteMatcher\RouteMatcherInterface', array('match'));
    ...
    {
        $this->setExpectedException('Laminas\Mvc\Router\Exception\InvalidArgumentException');
